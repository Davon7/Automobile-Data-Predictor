...
st.markdown("<h4 style = 'margin: -30px; color: #FFC470; text-align: center; font-family: Serif '>David Onyeabo</h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html=True)

# #get an image
st.image('pngwing.com (10).png', caption = 'Built by David')    
